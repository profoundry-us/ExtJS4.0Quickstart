...
Looking to get started with Ext JS 4.0? Look no futher! This quickstart is a complete project ready for you to
modify to your heart's content. It contains only the essentials. This means the few Ext Javascript files
necessary for running an application in debug mode and the CSS necessary to display properly.
